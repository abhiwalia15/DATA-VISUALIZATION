...
url = 'https://api.github.com/search/repositories?q=language:django&sort=stars'
r = requests.get(url)
...
chart.title = 'MOST -STARRED Django PROJECTS ON GITHUB'
chart.x_label = names
chart.add(' ', plot_dicts)
chart.render_to_file('django_repos.svg')
''' 
